...
import top.theillusivec4.bombindown.container.MenuBar;
import top.theillusivec4.bombindown.container.ShowsContainer;
import top.theillusivec4.bombindown.container.VideosContainer;
...
public class BombinDown {
  ...
  public static void main(String[] args) {
    BombinDownLogger.load();
    FileManager.load();
    DataManager.load();
    GiantBombApi.init();
    SwingUtilities.invokeLater(BombinDown::initGui);
  }
  ...
  private static void initGui() {
    BombinDownLogger.log("Starting application...");
    try {
      UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
    } catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException e) {
      BombinDownLogger.warn("Failed to set GUI appearance.", e);
    }
  ...
  private static void createAndShowGUI() {
    BombinDownLogger.log("Setting up GUI...");
